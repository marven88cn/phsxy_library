...
public class SPUtils {
    ...
    private SPUtils(final String spName) {
        sp = AppContextUtil.sContext.getSharedPreferences(spName, Context.MODE_PRIVATE);
    }

    private SPUtils(final String spName, final int mode) {
        sp =AppContextUtil.sContext.getSharedPreferences(spName, mode);
    }
