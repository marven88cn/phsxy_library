...
public class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        AppContextUtil.sContext.startActivity(
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) AppContextUtil.sContext.getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) AppContextUtil.sContext.getSystemService(WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) AppContextUtil.sContext.getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) AppContextUtil.sContext.getSystemService(Context.WIFI_SERVICE);
        if (wm == null) return "";
