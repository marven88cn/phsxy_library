...
public class DateTimeUtil {
     ...
     *
     * @param date 时间
     * @return 返回时间间断字符串 eg：几分钟前、几小时前、几天前、几月前、几年前、刚刚
     */
    ...
    /**
     * date转yyyy-MM-dd类型日期
     * @param dateDate date日期
     * @return yyyy-MM-dd类型日期
     */
    @SuppressLint("SimpleDateFormat")
     ...
     * 获取两个日期的时间差
     * @param date 日期
     * @return  yyyy-MM-dd HH:mm:ss格式日期差
     */
    @SuppressLint("SimpleDateFormat")
