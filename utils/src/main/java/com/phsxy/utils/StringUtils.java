...
public class StringUtils {
     ...
     * @return String 显示
     */
    public static String getParseDouble(Double mDouble) {
        if (mDouble == null) {
            return "0.0000";
        }
    ...
    public static String getPhoneNumTail4(String phoneNum) {
        if (TextUtils.isEmpty(phoneNum)) {
            return "";
        }
        return "(" + phoneNum.substring(7) + ")";
    }
    ...
    public static String getEditStr(TextView textView){
