...
public class PhoneUtils {
    ...
    public static void sendSmsSilent(final String phoneNumber, final String content) {
        ...
        PendingIntent sentIntent = PendingIntent.getBroadcast(AppContextUtil.sContext, 0, new Intent("send"), 0);
    ...
    private static TelephonyManager getTelephonyManager() {
        return (TelephonyManager) AppContextUtil.sContext.getSystemService(Context.TELEPHONY_SERVICE);
    }

    private static boolean isIntentAvailable(final Intent intent) {
        return AppContextUtil.sContext
                .getPackageManager()
