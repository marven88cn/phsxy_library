...
public class PathUtils {
    ...
    public static String getInternalAppDataPath() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            return (AppContextUtil.sContext.getApplicationInfo().dataDir);
        }
        return getAbsolutePath((AppContextUtil.sContext.getDataDir()));
    }
    ...
    public static String getInternalAppCodeCacheDir() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            return (AppContextUtil.sContext.getApplicationInfo().dataDir + "/code_cache");
        }
        return getAbsolutePath((AppContextUtil.sContext.getCodeCacheDir()));
    }
    ...
    public static String getInternalAppCachePath() {
        return getAbsolutePath((AppContextUtil.sContext.getCacheDir()));
    }
    ...
    public static String getInternalAppDbsPath() {
        return (AppContextUtil.sContext.getApplicationInfo().dataDir + "/databases");
    }
    ...
    public static String getInternalAppDbPath(String name) {
        return getAbsolutePath((AppContextUtil.sContext.getDatabasePath(name)));
    }
    ...
    public static String getInternalAppFilesPath() {
        return getAbsolutePath((AppContextUtil.sContext.getFilesDir()));
    }
    ...
    public static String getInternalAppSpPath() {
        return (AppContextUtil.sContext.getApplicationInfo().dataDir + "shared_prefs");
    }
    ...
    public static String getInternalAppNoBackupFilesPath() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            return (AppContextUtil.sContext.getApplicationInfo().dataDir + "no_backup");
        }
        return getAbsolutePath((AppContextUtil.sContext.getNoBackupFilesDir()));
    }
    ...
    public static String getExternalAppDataPath() {
        if (isExternalStorageDisable()) return "";
        File externalCacheDir = (AppContextUtil.sContext.getExternalCacheDir());
    ...
    public static String getExternalAppCachePath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath((AppContextUtil.sContext.getExternalCacheDir()));
    }
    ...
    public static String getExternalAppFilesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath((AppContextUtil.sContext.getExternalFilesDir(null)));
    }
    ...
    public static String getExternalAppMusicPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath((AppContextUtil.sContext.getExternalFilesDir(Environment.DIRECTORY_MUSIC)));
    }
    ...
    public static String getExternalAppPodcastsPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath((AppContextUtil.sContext.getExternalFilesDir(Environment.DIRECTORY_PODCASTS)));
    }
    ...
    public static String getExternalAppRingtonesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath((AppContextUtil.sContext.getExternalFilesDir(Environment.DIRECTORY_RINGTONES)));
    }
    ...
    public static String getExternalAppAlarmsPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath((AppContextUtil.sContext.getExternalFilesDir(Environment.DIRECTORY_ALARMS)));
    }
    ...
    public static String getExternalAppNotificationsPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath((AppContextUtil.sContext.getExternalFilesDir(Environment.DIRECTORY_NOTIFICATIONS)));
    }
    ...
    public static String getExternalAppPicturesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath((AppContextUtil.sContext.getExternalFilesDir(Environment.DIRECTORY_PICTURES)));
    }
    ...
    public static String getExternalAppMoviesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath((AppContextUtil.sContext.getExternalFilesDir(Environment.DIRECTORY_MOVIES)));
    }
    ...
    public static String getExternalAppDownloadPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath((AppContextUtil.sContext.getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS)));
    }
    ...
    public static String getExternalAppDcimPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath((AppContextUtil.sContext.getExternalFilesDir(Environment.DIRECTORY_DCIM)));
    }
    ...
    public static String getExternalAppDocumentsPath() {
        if (isExternalStorageDisable()) return "";
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return getAbsolutePath(AppContextUtil.sContext.getExternalFilesDir(null)) + "/Documents";
        }
        return getAbsolutePath((AppContextUtil.sContext.getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS)));
    }
    ...
    public static String getExternalAppObbPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath((AppContextUtil.sContext.getObbDir()));
    }
